...
export function ProjectHeader({ project }: { project: StudioProjectSample }) {
  return (
    <div className="project-header">
      <div>
        <a href="#" className="back-link"><ArrowLeft size={15} /> Back to projects</a>
      ...
      <div className="project-actions">
        ...
        <button className="button button--quiet" type="button"><LayoutDashboard size={16} /> Project dashboard</button>
      </div>
    </div>
  );
}
