...
export function MarketingFooter() {
  return (
    <footer className="marketing-footer" id="help">
      <div className="footer-cta"><span>Start with the business</span><h2>Turn your business into a website you own.</h2><p>Pages, copy, imagery, and brand styling—prepared for WordPress and ready to install.</p><a className="marketing-button" href="/studio?step=details">Start in Studio <ArrowRight size={17} /></a></div>
