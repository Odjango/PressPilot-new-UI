...
export function MarketingHeader() {
  return (
    <header className="marketing-header">
      <a className="marketing-brand" href="#top" aria-label="PressPilot home">
      ...
      <div className="marketing-header__actions">
        ...
        <a className="marketing-button marketing-button--small" href="/studio">Start in Studio <ArrowUpRight size={15} /></a>
      </div>
